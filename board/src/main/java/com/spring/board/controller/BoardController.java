...
public class BoardController {
	...
	public BoardDto getBoardDetail(HttpServletRequest request, HttpServletResponse response, BoardForm boardForm) throws Exception {
		...
		MDC.put("TRANSACTION_ID", String.valueOf(boardForm.getB_num()));
	...
	/*비네아_게시글을 수정합니다*/
	@RequestMapping(value = "/updateBoard", produces="text/plain;charset=UTF-8")
	@ResponseBody
	...
	/*게시글 작성시에 사용자가 업로드 하고 싶은 파일을 업로드 할 수 있습니다*/
